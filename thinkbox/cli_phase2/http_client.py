"""HTTP client with timeouts and retries (PR #178 F05)."""
...
from thinkbox.cli_phase2.errors import CliToolkitError, transport_error
from thinkbox.cli_phase2.observability import correlation_headers
from thinkbox.cli_phase2.retry import RetryPolicy, default_retry_policy, run_with_retry
from thinkbox.cli_phase2.transport import HttpTransport


def _is_retriable(exc: Exception) -> bool:
    if isinstance(exc, CliToolkitError):
