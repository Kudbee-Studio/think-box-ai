"""Help UX polish — grouped command catalog (PR #196 F15)."""

from __future__ import annotations

from thinkbox.cli_phase4.completion import PHASE3_SUBCOMMANDS
...
def format_help_catalog() -> str:
    lines = ["KUDBEECLI Phase 4 commands (hermetic):"]
