"""Exit-code contract for Phase 3 CLI commands (PR #180 F05)."""
...
CLI_PHASE3_EXIT_CONTRACT: dict[str, int] = {
    "ok": CLI_EXIT_OK,
...
def map_outcome(outcome: str) -> int:
    ...
    if outcome not in CLI_PHASE3_EXIT_CONTRACT:
        return CLI_EXIT_FAIL
    return CLI_PHASE3_EXIT_CONTRACT[outcome]
