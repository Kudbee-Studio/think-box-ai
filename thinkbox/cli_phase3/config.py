"""Fail-closed Phase 3 env config (PR #180 F23)."""
...
from thinkbox.cli_phase3.errors import profile_error, validation_error


@dataclass(frozen=True)
class CliPhase3Config:
    active_profile: str
    output_format: str
    max_parallel: int
    cassette_dir: str
...
def load_phase3_config_from_env(environ: dict[str, str] | None = None) -> CliPhase3Config:
    ...
    cassette = (env.get("THINKBOX_CLI_CASSETTE_DIR") or "data/cli_phase3/cassettes").strip()
