...
| KUDBEECLI Phase 3 (~25 hermetic CLI deepen features) | **#180** | **Merged** — `docs/guides/kudbee_cli_phase3_quickstart.md` |
| Kudbee SDK follow-up wave 2 (~25 hermetic deepen features) | **#181** | **Draft** — `docs/guides/kudbee_sdk_followup_w2_quickstart.md` |
