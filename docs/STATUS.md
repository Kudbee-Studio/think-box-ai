...
3. **`tests/e2e/` Think Job lifecycle** — F023 hermetic lifecycle on draft PR #130 (`test_f023_think_job_lifecycle.py`); live `POST /run` + Mercury still out of scope
...
|--------|-------|----|---------|-------------------|--------|
| All unit + integration + e2e | 2298 | ✅ | 8 | 3 | ✅ PASS (PR #130 draft gate) |
