...
> **#225 open:** seed pack catalog by seed on `cursor/memory-trait-lab-seed-pack-catalog-seed-723f`. Not merged.
> **Test gate:** memory suite 102 OK; engine harden 61 OK (163 combined). #225 not merged.
