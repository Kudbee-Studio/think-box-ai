...
>
> - **PR #83 open** (10 additional scheduler features): WeightedFairQueue, JobLease, DedupedDelayedEnqueue, CircuitBreaker, AdmissionLottery, PlacementConstraints, ProgressiveDrain, ReplayFromLedger, MultiPriorityAging, SchedulerCanary. All tests deterministic (mocked clock). Scheduler tests 571 OK.
>
