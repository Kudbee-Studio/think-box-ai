...
| CI spine-trust slimming (PR CI trusts fast spine + explicit lint execute) | **#172** (draft) | `thinkbox/kilo_pr172_ci_spine_trust.py`, `scripts/verify_kilo_pr172_ci_spine_trust.py`, `.github/workflows/test.yml` |
